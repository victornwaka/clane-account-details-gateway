package net.arca.openbanking.account_details;
...
@EnableSwagger2
@Configuration
public class AccountDetailsGatewayApplication {
	...
	public static void main(String[] args) {
		...
		SpringApplication.run(AccountDetailsGatewayApplication.class, args);
